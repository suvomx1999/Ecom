...
export default async function AdminDashboardPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-gray-600">Manage users, products, and settings.</p>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-3xl font-semibold text-gray-900">{sellerCount}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-3xl font-semibold text-gray-900">{customerCount}</dd>
                </dl>
              </div>
            </div>
          </div>
